...
describe('The memory database', () => {
  ...
  it('should find all documents with ascending order', () => {
    ...
    let findAll = database.findAll('collection', {}, {sort: {name: 1}});
  ...
  it('should find all documents based on a date', () => {
    let documents = [
      {id: '1', date: new Date(2010, 2, 3, 0, 0, 0, 0)},
      {id: '2', date: new Date(2010, 8, 8, 0, 0, 0, 0)},
      {id: '3', date: new Date(2010, 2, 3, 0, 0, 0, 0)}
    ];
    database.collections.collection = documents;

    let findAll = database.findAll('collection', {date: new Date(2010, 2, 3, 0, 0, 0, 0)});
