...
describe('The repository', () => {
  ...
  it('wont reject when first entity cannot be found and option to not fail is passed', () => {
    let findFirst = repository.findFirst({name: 'entity'}, {noFailure: true});

    return findFirst.should.eventually.be.fullfilled;
  });
